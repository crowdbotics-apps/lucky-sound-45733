"""
Django settings for lucky_sound_45733 project.
...
ROOT_URLCONF = 'lucky_sound_45733.urls'
...
WSGI_APPLICATION = 'lucky_sound_45733.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_sound_45733 API",
    "DESCRIPTION": "API documentation for lucky_sound_45733 App",
    "VERSION": "v1",
}
